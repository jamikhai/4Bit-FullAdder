...
HD_PWD='C:/Users/Justin Mikhail/Documents/VHDLProjects/FullAdder4Bit/FullAdder4Bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder4bit.tcl
